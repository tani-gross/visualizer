...
const Home = () => {
    ...
    return (  
        ...
        <section className="home-section">
            <h1>Welcome to the Graph and Sorting Visualizer</h1>
        ...
        <section className="home-section">
            ...
            <ol>
                ...
                <li>Click the "Start" button to begin the visualization. For graph algorithms you can pause, resume, or step through the algorithm using the control buttons.</li>
